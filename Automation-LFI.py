...
payloads = open('/home/kali/Desktop/Pentest/Web/hunt/Automation/LFI/LFI.txt', 'r').read().split('\n')
...
def test_lfi(url, payload):
    for u in url:
        ...
        if len(payload_response.text) > len(normal_response.text):
            ...
            lfi = open('/home/kali/Desktop/Pentest/Web/hunt/Automation/LFI/LFI_results.txt', 'a')
            f.write(f"{al}\n")
